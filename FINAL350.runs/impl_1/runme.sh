...
HD_PWD='C:/Users/manny/ECE350/Final350Project/FINAL350.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_camera_vga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_camera_vga.tcl -notrace
