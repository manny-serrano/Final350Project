...
HD_PWD='C:/Users/manny/ECE350/Final350Project/FINAL350.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_camera_vga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_camera_vga.tcl
